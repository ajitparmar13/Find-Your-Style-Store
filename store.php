...
<html>
    <head>
        <title>Find Your Style! | Store</title>
    ...
    <body>
        ...
        <section class="container content-section">
            <h2 class="section-header">Quick LookBook</h2>
                  <h1 class="band-name band-name-large">Summer 2020</h1>
        </header>
        <section class="container content-section">
            <div class="shop-items">
                ...
                <div class="shop-item">
                    <span class="shop-item-title">Reebok</span>
                ...
                <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Under Armour</span>
                    <img class="shop-item-image" src="images/ON1.jpeg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$12.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                ...
                <div class="shop-item">
                    <span class="shop-item-title">New Balance</span>
                    <img class="shop-item-image" src="images/BR1.jpeg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$14.99</span>
                        <button class="btn btn-primary shop-item-button"type="button">ADD TO CART</button>
                ...
                <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Asics</span>
                    <img class="shop-item-image" src="images/GAP1.jpeg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$12.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
