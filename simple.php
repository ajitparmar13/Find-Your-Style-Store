...
<html>
    ...
    <body>
        <header class="main-header">
            ...
            <h1 class="brand-name brand-name-large">Simple Clothes</h1>
        </header>
        <section class="container content-section">
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Old Navy</span>
                ...
                <div class="shop-item">
                    <span class="shop-item-title">Banana Republic</span>
                ...
                <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Gap</span>
                ...
                <div class="shop-item">
                    <span class="shop-item-title">Fruit of The Loom</span>
